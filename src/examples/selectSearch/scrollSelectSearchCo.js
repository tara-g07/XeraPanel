...
export default function ScrollSelectCo({ title, state, data, setDatas, name, defaultValue, value }) {
  const agenturl = "v1/api/admin/company/fetch";
  ...
  const changhandler = (event, value) => {
    setDatas({ ...data, coName:value?.name });
  };
  ...
  return (
    <Autocomplete
      ...
      options={options}
      loading={loading}
      noOptionsText={" No case has been found! "}
