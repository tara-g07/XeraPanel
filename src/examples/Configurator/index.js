...
function Configurator() {
  ...
  const sidenavColors = ["primary", "dark", "info", "success", "warning", "error", "mainColor"];
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      ...
      >
        <SoftBox>
          <SoftTypography variant="h5"> Admin Pannel Setting </SoftTypography>
        </SoftBox>
      ...
      <SoftBox pt={1.25} pb={3} px={3}>
        <SoftBox>
          <SoftTypography variant="h6"> Menu color </SoftTypography>
        ...
        <SoftBox mt={3} lineHeight={1}>
          <SoftTypography variant="h6"> Menu model </SoftTypography>
